...
/* insert(q, item, pri)
 * This function inserts the given item into the priority queue, q, with the
 * priority of pri. */
 ...
 * This function inserts a cell after p with the given item and priority if the
 * cell's priority is higher than pri.*/
void insertCell(PQCell*& p, const PQItemType& item, PQPriorityType pri)
{
	if (p == NULL)
	{
