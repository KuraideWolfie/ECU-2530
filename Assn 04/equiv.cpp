...
/* This file contains functions pertaining to the management of equivalence
 * relations and equivalence classes. Debugging functions are available to
 * display an equivalence relation and its classes to the console screen. */
...
/* equivalent(e, x, y)
 * This function returns true if x and y are both in the same equivalence class
 * in an equivalence relation e. */
